...
const Footer = () => {
  return (
    <footer className="bg-body-bg relative pt-10">
      <div className="bg-linear-to-r from-[#224187] to-[#1780a6] hidden lg:block absolute w-full h-full top-0 -left-1/2 blur-390"></div>
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 sm:grid-cols-4 gap-10">
        ...
        <div className="flex flex-col gap-4">
          <div className="flex space-x-4 mt-4 text-lg">
            <a href="https://www.facebook.com/bigodtoken/" target="_blank" className="h-6.25 w-6.25 bg-[#16BBF9] flex justify-center items-center text-sm text-black rounded">
              <FaFacebookF color="#fff" />
            </a>
            <a href="https://www.youtube.com/@bigodtoken" target="_blank" className="h-6.25 w-6.25 bg-[#16BBF9] flex justify-center items-center text-sm text-black rounded">
              <IoLogoYoutube color="#fff" />
            </a>
            <a href="https://www.instagram.com/bigod.token/" target="_blank" className="h-6.25 w-6.25 bg-[#16BBF9] flex justify-center items-center text-sm text-black rounded">
              <FaInstagram color="#fff" />
            </a>
              <a href="https://x.com/BiGODToken" target="_blank" className="h-6.25 w-6.25 bg-[#16BBF9] flex justify-center items-center text-sm text-black rounded">
              <FaXTwitter color="#fff" />
            </a>
              <a href="https://t.me/+l_SYVIc9gPkyNzk1" target="_blank" className="h-6.25 w-6.25 bg-[#16BBF9] flex justify-center items-center text-sm text-black rounded">
