  ...
  return (
    <section id="features-section" className="relative">
      ...
      <div className="container relative">
        ...
        width={105}
        height={35}
        className="absolute top-4 -left-6 opacity-40 hidden lg:block"
      />
      ...
      <Image
        ...
        width={105}
        height={35}
        className="absolute top-4 -right-6 opacity-40 rotate-180 hidden lg:block"
      />
        <Image
        src={goldendots}
        alt="arrow-bg"
      ...
      />
        ...
        <div className="w-full flex flex-col justify-center items-center">
          ...
          <div className="flex md:flex-row flex-col justify-content-between gap-5 align-items-center ">
            <div className="flex flex-col md:gap-y-20 gap-y-14 gap-x-20 md:mt-20 mt-10">
